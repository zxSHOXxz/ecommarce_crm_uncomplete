                        ...
                        <div class="col text-center py-5">
                            ...
                            <div class="col-12 text-center px-2" dir="ltr" style="padding-top: 8px;">
                                <a href="/" class="d-inline-block ">
                                    <span class="btn btn-primary cairo px-5"
                                        style=" padding: 5px 10px 9px;cursor: pointer;border:none;border-radius: 90px;">
                                        <span class="fal fa-home font-1 " style="color: #fff"></span> الرئيسية </span>
                                </a>
                            </div>
                        </div>
                    </div>

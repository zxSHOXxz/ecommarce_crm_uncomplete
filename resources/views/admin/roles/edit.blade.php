                ...
                <div class="col-12 col-lg-5 p-0 main-box">
                    ...
                    <div class="col-12 p-2">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @php
                                    $permissions = \Spatie\Permission\Models\Permission::where('guard_name', $role->guard_name)
                                        ->groupBy('table')
                                        ->get();
                                @endphp
                                @foreach ($permissions as $permission)
                                    @php
                                        $sub_permissions = \Spatie\Permission\Models\Permission::where('guard_name', $permission->guard_name)
                                            ->where('table', $permission->table)
                                            ->get();
                                    @endphp
                                    <tr>

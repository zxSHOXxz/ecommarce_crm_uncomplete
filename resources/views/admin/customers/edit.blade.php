...
<div class="col-12 p-3">
	<!-- breadcrumb -->
		<x-bread-crumb :breads="[
			...
			['url' => route('admin.customers.index') , 'title' => 'المستخدمين' , 'isactive' => false],
			...
			<div class="col-12 col-lg-6 p-2">
				...
				<div class="col-12 pt-3">
					<select class="form-control" name="blocked">
						<option @if($customer->blocked=="0") selected @endif value="0">لا</option>
						<option @if($customer->blocked=="1") selected @endif value="1">نعم</option>
					</select>
				</div>
			</div>
			</div>

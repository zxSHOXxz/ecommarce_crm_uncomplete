                ...
                <div class="col-12 p-4 align-items-center justify-content-center d-flex row" style="min-height:70vh">
                    ...
                    <div class="col-12 p-3 p-lg-4" style="background:#fff;border-radius: 10px;">
                        ...
                        <form class="d-block mt-3" method="POST" action="{{ route('verification.send') }}">
                            @csrf
                            <button type="submit"
                                class="btn btn-success py-2 px-3 m-0 align-baseline">{{ __('click here to request another') }}</button>
                        </form>
                    </div>
            ...
            <div class="col-12 col-lg-6 d-none d-lg-flex text-center p-0 d-flex align-items-center justify-content-center row position-relative"
                ...
                <div class="overlap-grid overlap-grid-2">
                    <div class="item mx-auto">
                        ...
                        <div class="col-12 p-0 align-items-center py-5 justify-content-center d-flex "
                            style="background-image: url('/images/character.webp');background-size: cover;padding-top: 57%;background-position: center;height: 342px;z-index: 1;position: relative;">
                        </div>
                    </div>
                </div>
            </div>
